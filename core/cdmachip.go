...
type cdmaMeta struct {
	/// Meta Data
	spreadSeq vlib.VectorC
	sf        int
}

func (m *cdmaMeta) UnmarshalJSON(data []byte) (err error) {
...
func (m *cdmaMeta) MarshalJSON() ([]byte, error) {
	info := make(map[string]interface{})
	info["spreadSeq"] = m.spreadSeq.String()
	var result []byte
	json.Marshal(info)
	err := errors.New("")
	return result, err
...
func (m *cdmaMeta) update(data map[string]interface{}) {
	var value interface{}

	value = data["spreadSeq"]
	if value != nil {
...
func (m *CDMA) SetJson(data []byte) {
	m.cdmaMeta.setDefaults()
	result := chipset.GetMetaInfo(data, m.Name())
	m.update(result)
}
func (m *CDMA) Set(data cdmaMeta) {
	m.cdmaMeta = data
}
func (m *CDMA) GetJson() []byte {

	var obj map[string]interface{}
	obj = make(map[string]interface{})
	obj["Object"] = m.Name()
	obj["ObjectAttributes"] = m.Get()
	data, err := json.Marshal(m.cdmaMeta)
	if err != nil {
